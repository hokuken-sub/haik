...
//    	adjustToolBox();
		...
		// ! Share buttons
		if ($("#haik_nav .share_buttons").length) {
			var $share_buttons = $("#haik_nav .share_buttons");
			...
			if ($share_buttons.hasClass("right")) {
				...
				if ($("#haik_nav > ul").css("float") == "right") {
					$share_buttons.prependTo("#haik_nav");
				}
			}
			else {
