...
//      skipTooltipButton.className = 'introjs-button introjs-skipbutton';
    ...
    if (this._introItems.length - 1 == this._currentStep) {
      ...
      nextTooltipButton.className = 'btn btn-default btn-sm introjs-nextbutton disabled';
/*
      prevTooltipButton.className = 'introjs-button introjs-prevbutton';
      nextTooltipButton.className = 'introjs-button introjs-nextbutton introjs-disabled';
*/
    } else if (this._currentStep == 0) {
      prevTooltipButton.className = 'btn btn-default btn-sm introjs-prevbutton disabled';
