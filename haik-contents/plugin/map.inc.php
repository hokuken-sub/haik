...
{
	global $vars, $whatsnew, $defaultpage, $non_list, $script, $username;
	$qm = get_qm();
	...
	// Get pages
	$pages = array_values(array_diff($user === $username ? get_existpages() : get_readable_pages($user), array($whatsnew)));
